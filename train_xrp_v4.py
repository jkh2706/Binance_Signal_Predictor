...
from model_training import train_model, BEST_PARAMS_XRP

# 기존 모듈 유지
from data_fetcher import fetch_historical_data

def train_xrp_xgboost_model_v4(symbol='XRPUSDT'):
    ...
    # 5. 모델 학습 (PCA 포함된 통합 파이프라인 사용)
    print("XGBoost 모델 및 PCA 학습 중...")
    model, scaler, pca = train_model(X_train, y_train, params=BEST_PARAMS_XRP, use_pca=True, n_components=25)
